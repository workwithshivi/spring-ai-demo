...
public class AiModelConfig {
    ...
    private Logger logger = LoggerFactory.getLogger(AiModelConfig.class);
    ...
    public ChatClient ollamaChatModel(OllamaChatModel chatModel, ChatMemory chatMemory) {
        ...
        return ChatClient.builder(chatModel).defaultAdvisors(messageChatMemoryAdvisor, new TokenPrintAdvisor(), new SimpleLoggerAdvisor(), new SafeGuardAdvisor(List.of("drugs", "booster"))) // setting advisors
